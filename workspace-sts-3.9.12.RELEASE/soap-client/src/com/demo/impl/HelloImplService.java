 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://impl.demo.com/", wsdlLocation = "http://localhost:4567/soapdemos/hellosoap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://impl.demo.com/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4567/soapdemos/hellosoap?wsdl");
    ...
    public IHello getHelloImplPort() {
        return super.getPort(new QName("http://impl.demo.com/", "HelloImplPort"), IHello.class);
    }
    ...
    public IHello getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.demo.com/", "HelloImplPort"), IHello.class, features);
    }
